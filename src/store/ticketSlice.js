...
export const visibleTickets = (tickets, count) =>
  createSelector([tickets, count], (tickets, count) => tickets.slice(0, count))
...
export const ticketsSlice = createSlice({
  ...
  reducers: {
    appendTickets: (state, action) => {
      state.tickets.push(...action.payload.sort((a, b) => a.price - b.price))
    },
